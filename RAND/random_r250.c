...
void RanSetSeed_generic_stream(void *stream, unsigned int *piSeed, int cSeed)  // !InTc!
{
...
unsigned int IRan_generic_stream(void *stream)       // !InTc!
{
  generic_state *state = stream ;
...
double DRan_generic_stream(void *stream)       // !InTc!
{
  generic_state *state = stream ;
...
double DRanS_generic_stream(void *stream)       // !InTc!
{
  generic_state *state = stream ;
...
void VecIRan_generic_stream(void *stream, unsigned int *ranbuf, int n)       // !InTc!
{
  generic_state *state = stream ;
...
void VecDRan_generic_stream(void *stream, double *ranbuf, int n)       // !InTc!
{
  generic_state *state = stream ;
...
void VecDRanS_generic_stream(void *stream, double *ranbuf, int n)       // !InTc!
{
  generic_state *state = stream ;
