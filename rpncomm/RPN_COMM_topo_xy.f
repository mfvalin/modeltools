...
* */
	...
	integer function RPN_COMM_topo_xy(nig,njg,mini,maxi,minj,maxj,
     %          nil,njl,haloi,haloj,peri,perj)
	use rpn_comm
	implicit none
	integer nig,njg,mini,maxi,minj,maxj
	integer nil,njl,haloi,haloj
	logical peri,perj
*
!	include 'rpn_comm.h'
!	include 'mpif.h'
